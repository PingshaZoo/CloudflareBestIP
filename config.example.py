...
# 域名数据源:域名列表 API 地址
DOMAINS_SET_URL = "https://la.abc.top/api/domainsCT"  

# IP 数据源:已经做过测试的数据源的旧结果
HAVE_POST_RES=[    
    "https://la.abc.top/api/domains/shayuan",
    "https://la.abc.top/api/domains/dell",
    "https://la.abc.top/api/domains/cgb",
    "https://la.abc.top/api/domains/jujule",
    "https://la.abc.top/api/domains/iphone",
    "https://abc.top/api/domains/shayuan",
    "https://abc.top/api/domains/dell",
    "https://abc.top/api/domains/cgb",
    "https://abc.top/api/domains/jujule",
    "https://abc.top/api/domains/iphone",
    ]
...
# ================= 探测参数 =================
SLEEP_INTERVAL = 3          # 单次探测间隔（秒），300秒=5分钟
TIMEOUT        = 7            # 单次探测超时（秒）
